...
Install the MQTT Engine module in your Ignition Gateway.

Point the MQTT Engine to your broker (localhost:1883 or your server IP).

Subscribe to the brewery/# namespace.

Tags will auto-populate in the Tag Browser under MQTT Engine/Edge Nodes/brewery/....

Use the UDT mappings below to build your data models.